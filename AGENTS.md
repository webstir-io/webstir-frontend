...
- Use `npm run release -- <patch|minor|major>` (scripts/publish.sh) for version bumps; it refreshes the lockfile, enforces clean git + build/test/smoke before tagging, and auto-cleans tags/commits if a later step fails.
